module.exports = {
  ...
  rules: {
    ...
    "keyword-spacing": 2,
    "lines-around-comment": 0,  // [2, { "allowBlockStart": true, "beforeBlockComment": true, "beforeLineComment": true }],
  ...
  env: {
    es6: true,
    node: true,
    jasmine: true,  // Jest uses Jasmine, which fact we rely on for fail()
    jest: true
  },
