...
function generateFunctionCall(astNode) {
  ...
  // { op: "arg", var: variableName, value, valueType }
 ...
 * from the given AST node's fn/args, var, or value/valueType properties.
 */
...
const generators = {
  "assign": (node) => {
    ...
    // { op: "assign", expression: undefined, valueType, value, toVar }
  ...
  "function": (node) => {
    ...
    // { op: "arg", var: variableName, value: undefined, valueType: undefined }
  ...
  "return": (node) => {
    ...
    // { op: "return", var: undefined, valueType, value }
  ...
  "output": (node) => {
    // { op: "output", var: fromVariableName }
    // { op: "output", var: undefined, valueType, value }
