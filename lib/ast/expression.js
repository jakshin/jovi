...
class Expression {
  ...
  addVariableOperand(variableName) {
    ...
    this._terms.push({ op: "operand", var: variableName })  // undefined: fn, args, value, valueType
    return this
  }
  ...
  addLiteralOperand(literalType, literalValue) {
    ...
    this._terms.push({ op: "operand", value: literalValue, valueType: literalType })  // undefined: fn, args, var
    return this
  }
  ...
  addFunctionCallOperand(functionName, argumentList) {
    ...
    this._terms.push({ op: "operand", fn: functionName, args: argumentList.toAST() })  // undefined: var, value, valueType
    return this
  }
