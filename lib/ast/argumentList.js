...
class ArgumentList {
  ...
  addArgument(variableName) {
    ...
    this._args.push({ op: "argument", var: variableName, value: undefined, valueType: undefined })
    return this
  }
  ...
  addArgumentWithLiteral(literalType, literalValue) {
    ...
    this._args.push({ op: "argument", var: undefined, value: literalValue, valueType: literalType })
    return this
  }
