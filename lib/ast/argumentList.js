...
class ArgumentList {
  ...
  addArgument(variableName) {
    ...
    this._args.push({ op: "arg", var: variableName, literalType: undefined, literalValue: undefined })
    return this
  }
  ...
  addArgumentWithLiteral(literalType, literalValue) {
    ...
    this._args.push({ op: "arg", var: undefined, literalType: literalType, literalValue: literalValue })
    return this
  }
