...
class AST {
  ...
  addAssignmentWithLiteral(toVariableName, literalType, literalValue) {
    ...
    this._add({ op: "assign", expression: undefined, valueType: literalType, value: literalValue, toVar: toVariableName })
  }
  ...
  addOutputWithLiteral(literalType, literalValue) {
    ...
    this._add({ op: "output", var: undefined, valueType: literalType, value: literalValue })
  }
