...
/**
 * Counts the alphabetical characters in a string, meaning English A-Z.
 * Case-insensitive.
 */
function countAlphabeticalChars(str) {
  return str.replace(/[^a-z]/ig, "").length
}

/**
 * Reports whether the given string consists solely of English characters,
 * and starts with a capital English letter. Returns false for empty strings.
 */
function isCapitalized(str) {
  return /^[a-z]+$/i.test(str) && /^[A-Z]/.test(str)
}

/**
 * Reports whether the given string consists solely of lowercase English characters.
 */
