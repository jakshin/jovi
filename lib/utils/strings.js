...
/**
 * Parses a numeric string into a number (integer or float). Can return NaN or Infinity.
 * You should probably check the string with isNumeric() before calling this.
 */
