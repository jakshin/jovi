...
function tokenize(src) {
  ...
  // throw a parser error if there is an unterminated comment which isn't all whitespace
  if (token.type === TokenType.COMMENT && token.str.trim()) {
    throw { message: "Unterminated comment", token }
  }
